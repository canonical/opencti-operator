...
This document explains the processes and practices recommended for contributing enhancements to the OpenCTI Operator.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/opencti-operator)
...
Canonical welcomes contributions to the OpenCTI Operator. Please check out our
...
OCI image for the OpenCTI app, and then upload the image to a MicroK8s registry,
