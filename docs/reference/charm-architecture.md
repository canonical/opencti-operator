...
[Pebble](https://documentation.ubuntu.com/pebble/) running as the workload container's 
entrypoint.
...
> See more: [How to publish your charm on Charmhub](https://documentation.ubuntu.com/juju/3.6/howto/manage-charms/)
...
base class from which all Charms are formed, defined by [Ops](https://documentation.ubuntu.com/ops/) 
