...
The full alert rules can be seen in the [alert rules file](https://github.com/canonical/opencti-operator/blob/main/src/prometheus_alert_rules/opencti.rule).
