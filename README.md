...
### Set up
You can follow the tutorial [here](https://canonical.com/juju/docs/juju-cli/latest/howto/manage-your-juju-deployment/set-up-your-juju-deployment-local-testing-and-development/)
